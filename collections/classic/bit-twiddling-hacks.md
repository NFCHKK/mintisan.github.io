...
## Find the log base 2 of an integer(aka the position of the highest bit set)
...
## Count the consecutive zero bits (or finding bit indices)
...
## Interleave bits (aka computing 'Morton Numbers')
